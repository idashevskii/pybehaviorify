...
class A(pybehaviorify.Composite):
    pass


class B(pybehaviorify.Decorator):
    pass


class C(pybehaviorify.Condition):
    pass


class D(pybehaviorify.Action):
    pass
...
data = {
    ...
    "display": {"camera_x": 492, "camera_y": 430.5, "camera_z": 1, "x": 0, "y": 0},
    "properties": {"a": 2},
    "nodes": {
...
#         tree = pybehaviorify.BehaviorTree()
...
#         class Custom(pybehaviorify.Condition):
#             title = "custom"

#         tree.properties = {"prop": "value", "comp": {"val1": 234, "val2": "value"}}
...
#         node4 = pybehaviorify.Wait()
#         node4.id = "node-4"
#         node4.title = "Node4"
#         node4.description = "Node 4 Description"

#         node3 = pybehaviorify.MemSequence([node5])
#         node3.id = "node-3"
#         node3.title = "Node3"
#         node3.description = "Node 3 Description"

#         node2 = pybehaviorify.Inverter(node4)
#         node2.id = "node-2"
#         node2.title = "Node2"
#         node2.description = "Node 2 Description"

#         node1 = pybehaviorify.Selector([node2, node3])
#         node1.id = "node-1"
#         node1.title = "Node1"
...
#         self.assertEqual(data["nodes"]["node-1"]["name"], "Selector")
